...
# ─────────────────────────────────────────────
#  SIDEBAR TOGGLE BUTTON (JS click on native toggle)
# ─────────────────────────────────────────────
st.markdown("""
<style>
    /* Always show the native Streamlit sidebar toggle */
...
<script>
    // Auto-click the native sidebar button if sidebar is collapsed
    ...
    setTimeout(ensureSidebarToggleVisible, 1500);
</script>
""", unsafe_allow_html=True)
...
st.markdown("""
<style>
    /* Force Streamlit's native sidebar toggle to always show */
    [data-testid="collapsedControl"] {
        display: flex !important;
        visibility: visible !important;
        opacity: 1 !important;
